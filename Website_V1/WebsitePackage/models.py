...
# ^^^^^^^^^^^^^^^^^^^^ VECTORS ^^^^^^^^^^^^^^^^^^^^ #
analysis_types_lst = ["Proteomic", "Proteomics DIA", "Proteomics DIA", "SWATH Proteomics", 
                      "Metabolomic", "ST Metabolomics", 
                      "Lipodomic"]
sites_lst          = ["Fremley", "ISARIC", "PHOSP"]
events_lst         = ["First Sample", "Second Sample", "Third Sample"]
sample_types_lst   = ["Serum", "Sebum", "Saliva"]
...
class Subjects(Base):
	...
	subjects_group_id	= Column(String, ForeignKey("subjects_groups.subjects_group_id"))
